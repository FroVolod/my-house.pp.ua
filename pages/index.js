...
class Index extends React.Component {
  state = {
    description:
      "Продам 2-х этажный дом (84 кв.м. жилой площади) в экологически чистом районе Харьковской области, с. Большие Проходы, Дергачевский р-н (20 км от Харькова).",
    imagesBlock: "all",
    selectBlock: "block_1"
  };
          ...
          <Row>
            <Col lg="1" xl="2">
              <div className="optim">
                ...
                <ul>
                  <li>
                    гараж в доме (при покупке квартиры дополнительные затраты на
                    стоянку или покупку гаража)
                  </li>
                  <li>
                    индивидуальное отопление (не нужно ждать отопительного
